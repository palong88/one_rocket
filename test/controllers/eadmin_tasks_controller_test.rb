...
class EadminTasksControllerTest < ActionController::TestCase
  ...
  test "should create eadmin_task" do
    assert_difference('EadminTask.count') do
      post :create, eadmin_task: { description: @eadmin_task.description, due_date: @eadmin_task.due_date, media: @eadmin_task.media, title: @eadmin_task.title }
    end
  ...
  test "should update eadmin_task" do
    patch :update, id: @eadmin_task, eadmin_task: { description: @eadmin_task.description, due_date: @eadmin_task.due_date, media: @eadmin_task.media, title: @eadmin_task.title }
    assert_redirected_to eadmin_task_path(assigns(:eadmin_task))
  end
