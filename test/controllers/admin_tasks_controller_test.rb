...
class AdminTasksControllerTest < ActionController::TestCase
  ...
  test "should create admin_task" do
    assert_difference('AdminTask.count') do
      post :create, admin_task: { description: @admin_task.description, due_date: @admin_task.due_date, media: @admin_task.media, title: @admin_task.title }
    end
  ...
  test "should update admin_task" do
    patch :update, id: @admin_task, admin_task: { description: @admin_task.description, due_date: @admin_task.due_date, media: @admin_task.media, title: @admin_task.title }
    assert_redirected_to admin_task_path(assigns(:admin_task))
  end
